...
==============================================================================================================
  ...
  The gold layer reprsents the final dimension and fact tables (star schema)
...
LEFT JOIN silver.erp_px_cat_g1v2 pc ON
	pn.cat_id = pc.id
WHERE prd_end_dt is NULL				---- Filter out all historical data, gives the current data.
